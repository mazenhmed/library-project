...
title = المكتبة المتكاملة

# (str) Package name
package.name = library_app
...
requirements = python3,kivy,kivymd,arabic-reshaper,python-bidi,sqlite3,reportlab
...
# (int) Target Android API, should be as high as possible (added to build.gradle)
android.api = 31
...
# (str) Filename of libpython.so
#android.libpython = libpython3.5m.so
...
# This property contains a map of key-value pairs.
